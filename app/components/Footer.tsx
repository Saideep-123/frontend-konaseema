  ...
  return (
    <footer id="contact" className="px-6 pt-16 pb-10 border-t border-gold bg-cream">
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-10">
        <div>
          <div className="brand-logo text-3xl mb-3">Konaseema Foods</div>
        ...
        <div>
          ...
          <div className="opacity-80 space-y-2">
            <div>Email: <a className="underline" href="mailto:konaseemafoods@example.com">konaseemafoods@example.com</a></div>
            <div>WhatsApp: <a className="underline" href="https://wa.me/91XXXXXXXXXX" target="_blank">+91 XXXXXXXXXX</a></div>
            <div>Instagram: <a className="underline" href="#" target="_blank">@konaseemafoods</a></div>
          </div>
        </div>
        ...
        <div>
          ...
          <a className="btn-primary inline-block bg-green-700 hover:bg-green-800" href="https://wa.me/91XXXXXXXXXX" target="_blank">
            WhatsApp Now
          </a>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto mt-10 pt-6 border-t border-gold opacity-70 text-sm flex flex-wrap gap-3 justify-between">
        <span>© {new Date().getFullYear()} Konaseema Foods. All rights reserved.</span>
